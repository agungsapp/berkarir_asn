																...
																<li class="nav-item navbar-dropdown dropdown-user dropdown">
																		<a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
																				<div class="avatar avatar-online">
																						<img src="{{ asset('sneat') }}/img/avatars/1.png" alt class="w-px-40 rounded-circle h-auto" />
																				</div>
																		</a>
																				...
																				<li>
																						<a class="dropdown-item" href="#">
																								<span class="d-flex align-items-center align-middle">
																										...
																										<span class="badge badge-center rounded-pill bg-danger w-px-20 h-px-20 flex-shrink-0">4</span>
																								</span>
																						</a>
																				</li>
																				<li>
																										...
																										<div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
																												<div class="d-flex flex-sm-column align-items-start justify-content-between flex-row">
																														...
																														<div class="mt-sm-auto">
																																<small class="text-success fw-semibold text-nowrap"
