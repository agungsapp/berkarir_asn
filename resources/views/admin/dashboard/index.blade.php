								...
								<div class="col-lg-6 col-md-12 col-6 mb-4">
										<div class="card">
												<div class="card-body">
														...
														<span>Sales</span>
														<h3 class="card-title mb-1 text-nowrap">$4,679</h3>
														...
														<div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
																<div class="d-flex flex-sm-column align-items-start justify-content-between flex-row">
																		...
																		<div class="mt-sm-auto">
																				<small class="text-success fw-semibold text-nowrap"><i class="bx bx-chevron-up"></i> 68.2%</small>
										...
										<ul class="m-0 p-0">
												<li class="d-flex mb-4 pb-1">
														<div class="avatar me-3 flex-shrink-0">
																<span class="avatar-initial bg-label-primary rounded"><i class="bx bx-mobile-alt"></i></span>
														</div>
												...
												<li class="d-flex mb-4 pb-1">
														<div class="avatar me-3 flex-shrink-0">
																<span class="avatar-initial bg-label-success rounded"><i class="bx bx-closet"></i></span>
														</div>
														<div class="d-flex w-100 align-items-center justify-content-between flex-wrap gap-2">
																<div class="me-2">
												...
												<li class="d-flex mb-4 pb-1">
														<div class="avatar me-3 flex-shrink-0">
																<span class="avatar-initial bg-label-info rounded"><i class="bx bx-home-alt"></i></span>
														</div>
														<div class="d-flex w-100 align-items-center justify-content-between flex-wrap gap-2">
																<div class="me-2">
												...
												<li class="d-flex">
														<div class="avatar me-3 flex-shrink-0">
																<span class="avatar-initial bg-label-secondary rounded"><i class="bx bx-football"></i></span>
														</div>
														<div class="d-flex w-100 align-items-center justify-content-between flex-wrap gap-2">
																<div class="me-2">
